  ...
  <body class="fixed-nav" id="page-top">
    ...
    <div class="content-wrapper py-3">
      ...
      <div class="container-fluid">
        ...
        UPDATE DATA KAS
        <?php foreach ($allkas as $row) {
        ?>
        <?php echo form_open('unit/kas/update_proc/'.$row->id_kas,array('id' => 'tambah','name' => 'tambah', 'class' => 'form-horizontal')); ?>
       <?php echo validation_errors(); ?>
        <table>
        <tr><td><div class="form-group">
            <label for="tanggal">Tanggal</label>
            <div>
              <input type="text" id="datepicker" name='tanggal' value="<?php echo $row->tanggal; ?>">
            </div>
            </div>
            </td>
            ...
            <option value="1000">--- Pilih Jenis Kas ---</option>
           <?php 
           foreach($daftarkas as $jeniskas)
            {
              $jenis_kasnya = $row->jenis_kas;
              if($jeniskas->id==$jenis_kasnya){                
            ...
            <?php
            $data = array('name' => 'nomor', 'id' => 'nomor', 'class' => 'form-control', 'placeholder' => 'Masukkan Nomor', 'value'=>$row->nomor);
           echo form_input($data); ?>
            ...
            <?php
            $data = array('name' => 'uraian', 'id' => 'uraian', 'class' => 'form-control', 'placeholder' => 'Masukkan Uraian','value'=>$row->uraian);
           echo form_input($data);?>
                </div>
            </td>
        </tr>
        ...
        <td><div class="form-group">
            ...
            <?php
            $data = array('name' => 'nobt', 'id' => 'nobt', 'class' => 'form-control', 'placeholder' => 'Masukkan No.Bt','value'=>$row->no_bt);
           echo form_input($data); ?>
                </div>
            </td>
            </tr>
        ...
        <td><div class="form-group">
            ...
            <?php
            $data = array('name' => 'nominal', 'id' => 'nominal', 'class' => 'form-control', 'placeholder' => 'Masukkan Nominal','value'=>$row->nominal);
           echo form_input($data); ?>
                </div>
            </td>
        </tr>
        ...
        <td><div class="form-group">
            ...
            <?php
            $data = array('name' => 'tahunpelajaran', 'id' => 'tahunpelajaran', 'class' => 'form-control', 'placeholder' => 'Masukkan Tahun Pelajaran','value'=>$row->tahunpelajaran);
           echo form_input($data); ?>
                </div>
            </td>
        </tr>
